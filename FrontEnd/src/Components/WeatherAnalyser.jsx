...
const weatherData = [
  // 🕐 Previous 7 days
  {
    ...
    wind: "8 km/h",
    precipitation: "20%",
    description: "Cool and cloudy morning, clearing up by afternoon.",
    condition: "cloudy",
  },
  {
    date: "2025-03-02",
    ...
    wind: "10 km/h",
    precipitation: "10%",
    description: "Mild and mostly sunny with gentle breeze.",
  ...
  },
  {
    ...
    wind: "11 km/h",
    precipitation: "12%",
    description: "Pleasant with scattered clouds during evening.",
  ...
  },
  {
    ...
    wind: "10 km/h",
    precipitation: "8%",
    description: "Sunny and comfortable with light winds.",
    condition: "sunny",
  },
  {
    date: "2025-03-05",
    ...
    wind: "9 km/h",
    precipitation: "10%",
    description: "Warm and bright day with clear skies.",
    condition: "sunny",
  },
  {
    date: "2025-03-06",
    ...
    wind: "12 km/h",
    precipitation: "15%",
    description: "Mostly clear with increasing humidity by night.",
    condition: "mostly-sunny",
  },
  {
    date: "2025-03-07",
    ...
    wind: "13 km/h",
    precipitation: "10%",
    description: "Pleasantly warm and partly cloudy.",
    condition: "partly-cloudy",
  },

  // 🌤 Existing forecast data (your original)
  {
    date: "2025-03-08",
    temperature: 17.5,
    details: {
  ...
  },
  {
    ...
    precipitation: "20%",
    description:
      "Pleasant day with light breeze and increasing clouds by evening.",
    condition: "cloudy",
  },
  {
    date: "2025-03-11",
    ...
    const props = {
      ...
      className: animate
        ? `transition-all duration-700 ${
            animationFrame % 2 === 0 ? "scale-105" : "scale-100"
          } ${
            animationFrame === 3
              ? "rotate-6"
              : animationFrame === 1
              ...
              className={`absolute bottom-0 right-0 opacity-60 ${
                animate
                  ? `transition-all duration-500 ${
                      animateCloud ? "translate-x-1" : "translate-x-0"
                    }`
                  : ""
              }`}
            />
    ...
    <div className="min-h-screen font-sans bg-linear-to-b from-gray-50 to-gray-100">
      <div className="fixed inset-0 overflow-hidden -z-10">
        <div
          className={`absolute top-10 left-10 opacity-5 transition-all duration-3000 ease-in-out ${
            animateCloud ? "translate-x-10" : "translate-x-0"
          }`}
        >
          <Cloud size={200} color="#334b35" />
        </div>
        <div
          className={`absolute bottom-20 right-20 opacity-5 transition-all duration-3000 ease-in-out delay-1000 ${
            animateCloud ? "translate-x-10" : "translate-x-0"
          }`}
        >
        ...
        <div
          className={`absolute top-1/3 right-1/3 opacity-5 transition-all duration-3000 ease-in-out delay-500 ${
            animateCloud ? "translate-y-10" : "translate-y-0"
          }`}
        >
          <Cloud size={150} color="#334b35" />
        </div>
        <div
          className={`absolute top-1/2 left-1/3 opacity-5 transition-all duration-3000 ease-in-out delay-1500 ${
            animateCloud ? "translate-y-8" : "translate-y-0"
          }`}
        >
      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <div className="bg-white shadow-lg p-6 mb-6 rounded-lg relative overflow-hidden transform transition-all duration-300 hover:scale-101 hover:shadow-xl">
          ...
          <div
            className={`absolute bottom-2 left-10 opacity-10 transition-all duration-2000 delay-500 ${
              animateCloud ? "translate-x-4" : "translate-x-0"
            }`}
          >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start relative z-10">
            <div className="mb-4 md:mb-0">
                ...
                <div>
                  ...
                  <div className="flex items-center text-xs text-gray-500 mt-1">
                    <span className="inline-flex items-center mr-2">
                      ...
                      <span>
                        Feels like {(today.temperature + 0.5).toFixed(1)}°C
                      </span>
                    </span>
                    <span>|</span>
              ...
              <div
                className={`text-gray-600 mt-4 max-w-md relative overflow-hidden bg-gray-50 p-3 rounded-lg border-l-4 border-smart-yellow ${
                  animationFrame % 3 === 0
                    ? "border-opacity-100"
                    : "border-opacity-70"
                }`}
            ...
            <div className="grid grid-cols-2 gap-4 p-4 rounded-lg border border-gray-100 shadow-md bg-linear-to-br from-white to-gray-50">
              <div className="flex flex-col items-center p-3 rounded-lg transition-all duration-300 hover:bg-smart-yellow/10 hover:scale-105">
                ...
                <p className="font-bold text-smart-green">
                  {today.details.morning}
                </p>
              </div>
              <div className="flex flex-col items-center p-3 rounded-lg transition-all duration-300 hover:bg-smart-yellow/10 hover:scale-105">
            ...
            <h2 className="font-bold text-smart-yellow flex items-center">
              ...
              <span
                className={`transition-all duration-300 ${
                  animationFrame % 2 === 0 ? "opacity-100" : "opacity-70"
                }`}
              >
                📅
              </span>
          ...
          <div className="overflow-x-auto">
            <div className="flex p-4 space-x-4">
              {weatherData.map((day, index) => (
                ...
                >
                  <div
                    className={`bg-smart-green p-2 rounded-t-lg relative overflow-hidden ${
                  ...
                  >
                    ...
                    ></div>
                    <p className="text-white text-center text-sm font-medium relative z-10">
                      {formatDate(day.date).split(",")[0]}
                    </p>
                  </div>
                  <div className="p-3 text-center">
                    <div
                      className={`text-2xl font-bold mb-2 text-smart-green transition-all duration-500 ${
                        selectedDay === index
                          ? "scale-110"
                          : hoveredIndex === index
                          ? "scale-105"
                    ...
                    <div
                      className={`text-xs p-1 rounded transition-all duration-300 ${
                        selectedDay === index
                          ? "bg-smart-yellow/10 text-smart-green"
                          : "text-gray-500"
                      }`}
                    >
                      {day.details.morning.split("°")[0]}° /{" "}
                      {day.details.afternoon.split("°")[0]}°
                    </div>
                    <div
          ...
          {selectedDay !== null && (
            <div className="border-t border-gray-200 animate-fadeIn">
              <div className="bg-linear-to-br from-white to-gray-50 p-5 relative overflow-hidden">
                ...
                <h3 className="font-bold text-smart-green text-xl mb-1">
                  {formatDate(weatherData[selectedDay].date)}
                </h3>
                <div className="flex items-center mb-4">
                  <div className="mr-2">
                    {getWeatherIcon(
                      weatherData[selectedDay].condition,
                      24,
                      true
                    )}
                  </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-100 transform transition-all duration-300 hover:scale-105 hover:bg-smart-yellow/5">
                    ...
                    <p className="font-bold text-smart-green">
                      {weatherData[selectedDay].details.morning}
                    </p>
                  </div>
                  <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-100 transform transition-all duration-300 hover:scale-105 hover:bg-smart-yellow/5">
                    <div className="flex items-center mb-2">
                    ...
                    <p className="font-bold text-smart-green">
                      {weatherData[selectedDay].details.afternoon}
                    </p>
                  </div>
                  <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-100 transform transition-all duration-300 hover:scale-105 hover:bg-smart-yellow/5">
                    <div className="flex items-center mb-2">
                    ...
                    <p className="font-bold text-smart-green">
                      {weatherData[selectedDay].details.evening}
                    </p>
                  </div>
                  <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-100 transform transition-all duration-300 hover:scale-105 hover:bg-smart-yellow/5">
                    <div className="flex items-center mb-2">
                    ...
                    <p className="font-bold text-smart-green">
                      {weatherData[selectedDay].details.night}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  ...
                  <div className="bg-blue-50 bg-opacity-30 p-3 rounded-lg flex items-center transform transition-all duration-300 hover:bg-blue-50">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-700">
                        {weatherData[selectedDay].precipitation}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-5 p-3 bg-smart-green bg-opacity-5 rounded-lg border-l-2 border-smart-yellow">
                  <h4 className="text-sm font-medium text-smart-green mb-1">
                    Weather Advisory
                  </h4>
                  <p className="text-sm text-gray-600">
                    {weatherData[selectedDay].precipitation.replace("%", "") >
                    20
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 transform transition-all duration-300 hover:shadow-md hover:border-smart-yellow">
                <h3 className="text-smart-green font-medium mb-2 flex items-center">
                  <ThermometerSun size={18} className="mr-2" /> Temperature
                  Trend
                </h3>
                <p className="text-sm text-gray-600">
                  Overall warming trend with temperatures rising from 17.5°C to
                  18.5°C over the week.
                </p>
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 transform transition-all duration-300 hover:shadow-md hover:border-smart-yellow">
                ...
                <p className="text-sm text-gray-600">
                  Low chance of precipitation through the week. Best chance of
                  rain on Tuesday (25%).
                </p>
                <div className="mt-2 h-6 bg-gray-200 rounded-full overflow-hidden">
                  <div
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 transform transition-all duration-300 hover:shadow-md hover:border-smart-yellow">
                ...
                <p className="text-sm text-gray-600">
                  Gentle breeze throughout the week, ranging from 8-14 km/h.
        ...
        <div className="mt-6 text-center text-gray-500 text-sm">
          <div
            className={`inline-block transform transition-all duration-1000 ${
              animateCloud ? "rotate-1 scale-102" : "rotate-0 scale-100"
            }`}
          >
