...
const predictionData = [
  {
    ...
    predictions: [
      { date: "2025-11-06", price: 18.5 },
      { date: "2025-11-13", price: 18.9 },
      { date: "2025-11-20", price: 19.3 },
      { date: "2025-11-27", price: 19.8 },
    ],
    trend: "up",
    category: "fruit",
    recommendation:
      "Banana prices show a steady upward trend (~7% over the month). Delay harvest slightly to gain better returns. Consider negotiating longer-term supply deals with retailers.",
  },
  {
    crop: "onion",
    unit: "Rs./Kg",
    ...
    predictions: [
      { date: "2025-11-06", price: 25.4 },
      { date: "2025-11-13", price: 25.8 },
      { date: "2025-11-20", price: 26.2 },
      { date: "2025-11-27", price: 26.9 },
    ],
    trend: "up",
    category: "vegetable",
    recommendation:
      "Onion prices continue a moderate rise as demand increases for festive season. Farmers should store produce under proper ventilation for best profits.",
  },
  {
    crop: "tomato",
    unit: "Rs./Kg",
    ...
    predictions: [
      { date: "2025-11-06", price: 13.1 },
      { date: "2025-11-13", price: 13.2 },
      { date: "2025-11-20", price: 13.3 },
      { date: "2025-11-27", price: 13.3 },
    ],
    trend: "stable",
    category: "vegetable",
    recommendation:
      "Tomato market remains stable. Prioritize freshness and local sales for better margins. Explore processed tomato options if you have excess yield.",
  },
  {
    crop: "wheat",
    unit: "Rs./Kg",
    ...
    predictions: [
      { date: "2025-11-06", price: 49.2 },
      { date: "2025-11-13", price: 50.1 },
      { date: "2025-11-20", price: 51.4 },
      { date: "2025-11-27", price: 52.0 },
    ],
    trend: "up",
    category: "grain",
    recommendation:
      "Wheat prices are rising slightly due to upcoming winter demand. Consider pre-booking sales for December when rates may peak.",
  },
  {
    crop: "carrot",
    unit: "Rs./Kg",
    ...
    predictions: [
      { date: "2025-11-06", price: 19.2 },
      { date: "2025-11-13", price: 19.7 },
      { date: "2025-11-20", price: 20.4 },
      { date: "2025-11-27", price: 21.0 },
    ],
    trend: "up",
    category: "vegetable",
    recommendation:
      "Carrot prices rising by ~10%. Great time to target wholesale and retail markets. Maintain steady supply to capture consistent buyers.",
  },
  {
    crop: "potato",
    unit: "Rs./Kg",
    ...
    predictions: [
      { date: "2025-11-06", price: 21.0 },
      { date: "2025-11-13", price: 21.4 },
      { date: "2025-11-20", price: 21.9 },
      { date: "2025-11-27", price: 22.3 },
    ],
    trend: "up",
    category: "vegetable",
    recommendation:
      "Gradual increase in potato prices expected. Farmers with cold storage can hold stock till late November for better returns.",
  },
  {
    crop: "rice",
    unit: "Rs./Kg",
    ...
    predictions: [
      { date: "2025-11-06", price: 54.0 },
      { date: "2025-11-13", price: 53.9 },
      { date: "2025-11-20", price: 53.7 },
      { date: "2025-11-27", price: 53.5 },
    ],
    trend: "down",
    category: "grain",
    recommendation:
      "Slight dip in rice prices expected due to high supply post-harvest. Selling earlier in the month may help avoid further decline.",
  },
];
...
const MarketPrediction = () => {
  ...
  const [notification, setNotification] = useState({
    show: true,
    message: "New price predictions available for all crops!",
  });
  const [apiData, setApiData] = useState(null);
  const [apiError, setApiError] = useState(null);

  // No backend integration: use local/static prediction data only
  useEffect(() => {
    // We're intentionally not calling any external API here.
    // Keep loading short so UI doesn't hang.
  ...
  useEffect(() => {
    ...
    const dataToFilter =
      apiData && apiData.length > 0 ? apiData : predictionData;
  ...
  return (
    <div className="min-h-screen bg-smart-green bg-opacity-95 text-white" id="market-predictor">
        ...
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold text-smart-yellow">
                KrishiPrice Forecast
              </h1>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        {showTips && (
          <div className="bg-gray-800 rounded-xl p-4 mb-8 animate-fadeIn">
            <h3 className="text-smart-yellow font-medium text-lg mb-3">
              How to Use This Forecast
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-900 p-3 rounded-lg">
                <h4 className="font-medium mb-2 flex items-center">
                  <Filter className="h-4 w-4 mr-1 text-smart-yellow" /> Price
                  Interpretation
                </h4>
                <p className="text-sm text-gray-300">
                  Rising prices indicate increasing demand or limited supply.
                  Consider timing your harvest or sales accordingly to maximize
                  profits.
                </p>
              </div>
              <div className="bg-gray-900 p-3 rounded-lg">
                <h4 className="font-medium mb-2 flex items-center">
                  <Calendar className="h-4 w-4 mr-1 text-smart-yellow" />{" "}
                  Seasonal Planning
                </h4>
                <p className="text-sm text-gray-300">
                  Use the weekly forecast to plan your planting and harvesting
                  schedule. Align your farm operations with projected market
                  conditions.
                </p>
              </div>
              <div className="bg-gray-900 p-3 rounded-lg">
                <h4 className="font-medium mb-2 flex items-center">
                  <AlertTriangle className="h-4 w-4 mr-1 text-smart-yellow" />{" "}
                  Risk Management
                </h4>
                <p className="text-sm text-gray-300">
                  Diversify your crops based on price stability. Crops with
                  stable prices offer reliable income, while those with rising
                  prices offer growth potential.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {filteredData.map((item) => {
              ...
              return (
                <div
                  key={item.crop}
                  className={`bg-gray-900 rounded-xl overflow-hidden shadow-lg border border-gray-800 transition-all duration-500 ease-in-out transform hover:shadow-xl ${
                    isExpanded
                    ...
                    <div className="p-4">
                      ...
                      <div className="mt-6">
                        <div className="flex justify-between items-center mb-3">
                          <h4 className="text-smart-yellow text-lg font-medium">
                            Price Forecast ({item.unit})
                          </h4>
                            ...
                            return (
                              <div
                                ...
                                className={`p-3 rounded-lg ${
                                  isLast
                                    ? "border-2 border-smart-yellow bg-gray-800"
                                    : "bg-gray-800"
                      ...
                      {isExpanded && (
                        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 animate-fadeIn">
                          <div className="bg-gray-800 rounded-lg p-4">
                            <h4 className="text-smart-yellow font-medium mb-3">
                              Market Insights
                            </h4>
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex justify-between items-center">
                                ...
                                <span className="text-sm font-medium">
                                  ₹{item.predictions[0].price.toFixed(2)}{" "}
                                  {item.unit}
                                </span>
                              </div>
                              ...
                              <div className="flex justify-between items-center">
                                ...
                                >
                                  {getProjectedDifference(item.predictions) > 0
                                    ? "+"
                                    : ""}
                                  ₹{getProjectedDifference(item.predictions)}{" "}
                                  {item.unit}
                                </span>
                              </div>
                            </div>
                              ...
                              {isNegativeChange && (
                                <>
                                  <li className="flex items-start">
                                    ...
                                    Consider early sales to avoid further
                                    decline
                                  </li>
                                  <li className="flex items-start">
                                    <span className="text-red-400 mr-2">•</span>
                                    Explore value-added products to increase
                                    margins
                                  </li>
                                  <li className="flex items-start">
                                    <span className="text-red-400 mr-2">•</span>
                                    Consider crop diversification for next
                                    season
                                  </li>
                                </>
                              )}
                              ...
                              {isStableChange && (
                                <>
                                  ...
                                  <li className="flex items-start">
                                    ...
                                    Consider direct marketing to increase
                                    margins
                                  </li>
                                </>
                              )}
        ...
        <div className="mt-12 bg-gray-800 rounded-xl p-6 animate-fadeIn">
          <h2 className="text-xl font-semibold text-smart-yellow mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-900 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-300 mb-3">
                These crops show significant price increases in the coming
                weeks.
              </p>
              <ul className="space-y-2">
                {filteredData
                  .filter(
                    (item) => parseFloat(calculateChange(item.predictions)) > 5
                  )
                  .slice(0, 3)
                  .map((item) => (
                    <li
                    ...
                    >
                      ...
                      <span className="text-green-400">
                        +{calculateChange(item.predictions)}%
                      </span>
                    </li>
                  ))}
              </ul>
            ...
            <div className="bg-gray-900 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-300 mb-3">
                These crops show relatively stable prices with minimal
                fluctuation.
              </p>
              <ul className="space-y-2">
                {filteredData
                  .filter(
                    (item) =>
                      Math.abs(parseFloat(calculateChange(item.predictions))) <=
                      5
                  )
                  .slice(0, 3)
                  .map((item) => (
            ...
            <div className="bg-gray-900 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-300 mb-3">
                These crops show price decreases in the coming weeks.
              </p>
              <ul className="space-y-2">
                {filteredData
                  .filter(
                    (item) => parseFloat(calculateChange(item.predictions)) < 0
                  )
                  .slice(0, 3)
                  .map((item) => (
                    <li
          ...
          <div className="mt-6 text-sm text-gray-400">
            <p>
              Based on analysis of historical price data, current market
              conditions, weather forecasts, and supply-demand indicators.
            </p>
          </div>
        </div>
