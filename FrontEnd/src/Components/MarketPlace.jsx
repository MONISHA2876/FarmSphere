...
const Marketplace = () => {
  ...
  const animatePress = (element) => {
    animate(element, { scale: 0.98 }, { duration: 0.1, ease: "easeOut" }).then(
      () => {
        ...
        >
          <div className="bg-smart-green p-6 text-white">
            <h1 className="text-3xl font-bold flex items-center">
              ...
              <span className="ml-3">FarmChain Marketplace</span>
            </h1>
            <p className="text-smart-yellow mt-2 opacity-90">
              Buy and sell crops on the blockchain
            </p>
          </div>
          ...
          <div className="p-6">
            ...
            {section === "list" && (
              <div id="list-section" className="space-y-6">
            ...
            {section === "buy" && (
              <div id="buy-section" className="space-y-6">
                <h2 className="text-2xl font-semibold text-smart-green flex items-center">
                ...
                <div className="space-y-4">
                  <div className="flex space-x-3">
                    ...
                    >
                      {loading ? (
                        <svg
                          className="animate-spin h-5 w-5 text-smart-green"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                        >
                  ...
                  <AnimatePresence>
                    {cropDetails && (
                      <div
                        ...
                        ref={(el) => el && animateIn(el)}
                      >
                        <h3 className="text-xl font-semibold text-smart-green mb-3">
                          Crop Details
                        </h3>
                        <div className="grid grid-cols-2 gap-4">
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="text-gray-500 text-sm">Name</p>
                            <p className="font-medium text-smart-green">
                              {cropDetails[0]}
                            </p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            ...
                            <p className="font-medium text-smart-green">
                              {cropDetails[1].toString()}
                            </p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="text-gray-500 text-sm">Price (wei)</p>
                            <p className="font-medium text-smart-green">
                              {cropDetails[2].toString()}
                            </p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="text-gray-500 text-sm">Seller</p>
                            <p className="font-medium text-smart-green truncate">
                              {cropDetails[3]}
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-sm">
                              You have successfully purchased this crop.
                            </p>
                          </div>
                        </div>
                      </div>
