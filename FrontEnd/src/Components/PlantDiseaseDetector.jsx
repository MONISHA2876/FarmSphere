  ...
  const openCamera = async () => {
    try {
      ...
      const tryThirdOption = () => {
        ...
        if (!videoRef.current) {
          console.error(
            "Video element is not available during second fallback"
          );
          alert("Camera initialization failed. Please try again.");
          setIsCameraOpen(false);
          return;
        ...
        videoRef.current.onerror = () => {
          ...
          alert(
            "Could not connect to DroidCam after multiple attempts. Please verify your DroidCam settings and network connection."
          );
          closeCamera();
        };
      };
      ...
      alert(
        "Could not access DroidCam. Please check your connection and DroidCam settings."
      );
      closeCamera();
    }
  };
    ...
    <div className="w-full min-h-screen bg-smart-green p-6 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <header className="text-center mb-8 pt-6">
          ...
          >
            ...
            <h1 className="text-white text-4xl md:text-5xl font-bold relative inline-block">
              ...
              <div
                className="absolute -bottom-2 left-0 w-full h-1 bg-smart-yellow transform scale-x-0 origin-left transition-transform duration-700"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div
            className={`bg-gray-800 bg-opacity-25 backdrop-blur-sm rounded-lg p-6 flex flex-col items-center transition-all duration-500 shadow-lg transform ${
              isLoaded
          ...
          >
            <div className="relative w-full aspect-square mb-6 bg-black bg-opacity-30 rounded-lg overflow-hidden flex items-center justify-center">
              {isCameraOpen ? (
                ...
                <div className="text-center p-6">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-20 w-20 mx-auto text-smart-yellow opacity-50 mb-4"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
            ...
            <div className="grid grid-cols-3 gap-4 w-full">
              ...
              <button
                ...
                className="col-span-1 bg-black bg-opacity-30 hover:bg-opacity-50 text-white py-3 px-4 rounded-lg flex items-center justify-center transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-smart-yellow"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-2 text-smart-yellow group-hover:scale-110 transition-transform duration-300"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
              ...
              {isCameraOpen ? (
                <>
                  <button
                    ...
                    className="col-span-1 bg-smart-yellow text-smart-green py-3 px-4 rounded-lg flex items-center justify-center transition-all duration-300 hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-smart-yellow"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <button
                    onClick={closeCamera}
                    className="col-span-1 bg-red-500 text-white py-3 px-4 rounded-lg flex items-center justify-center transition-all duration-300 hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-red-400"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 mr-2"
            ...
            {detectionResult && !isCameraOpen && (
              <div className="mt-6 w-full bg-black bg-opacity-30 backdrop-blur-sm rounded-lg p-4 text-white animate-fadeIn">
                <h3 className="text-lg font-bold text-smart-yellow border-b border-gray-700 pb-2 mb-3">
                  Analysis Results
                </h3>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div className="bg-black bg-opacity-30 p-3 rounded-lg">
                        ...
                        <p className="text-xl font-bold">
                          {detectionResult.predictions[0].class}
                        </p>
                      </div>
                      ...
                      <div className="bg-black bg-opacity-30 p-3 rounded-lg">
                        ...
                        <p className="text-xl font-bold">
                          {(
                            detectionResult.predictions[0].confidence * 100
                          ).toFixed(1)}
                          %
                        </p>
                      </div>
          ...
          <div className="flex flex-col gap-6">
            <div
              className={`bg-gray-800 bg-opacity-25 backdrop-blur-sm rounded-lg p-6 transition-all duration-500 shadow-lg transform ${
                isLoaded
            ...
            >
              <h3 className="text-xl font-bold text-white mb-4 flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 mr-2 text-smart-yellow"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
              ...
              <div className="space-y-4 text-gray-200 text-sm">
                <p>
                  Our AI-powered plant disease detection system uses computer
                  vision to identify diseases in crops. The system is trained on
                  thousands of images of healthy and diseased plants.
                </p>
                ...
                <p>
                  For best results, take close-up images of affected leaves or
                  stems in good lighting conditions.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="space-y-3">
                <p className="text-gray-300 text-sm mb-2">
                  Common diseases detected on your farm:
                </p>
                    ...
                    <div className="w-full bg-gray-700 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${
                            (disease.count /
                              Math.max(...diseases.map((d) => d.count))) *
                            100
                          }%`,
                        }}
                      ></div>
      ...
      <div
        className={`fixed bottom-6 right-6 z-20 transition-all duration-700 transform ${
      ...
      >
        <button
          onClick={() => navigate("/")}
          className="w-14 h-14 rounded-full bg-smart-yellow text-smart-green flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-smart-yellow"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
